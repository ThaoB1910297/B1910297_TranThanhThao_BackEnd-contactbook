...
exports.create = async (req, res, next) => {
    ...
    try{
        const contactService = new ContactServer(MongoDB.client);
...
exports.findAll = async(req, res, next) => {
    ...
    try{
        ...
        return next(
            new ApiError(500, "An error occurred while retrieving contatcs")
        );
    }
...
exports.findOne = async (req, res, next) => {
    try{
        ...
        return next(
            new ApiError(
                500,
                `Error retrieving contatc with id=${req.params.id}`
            )
        );
    }
};
